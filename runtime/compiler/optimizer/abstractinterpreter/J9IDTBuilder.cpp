...
void J9::IDTBuilder::performAbstractInterpretation(TR::IDTNode* node, TR::IDTBuilderVisitor& visitor, TR::AbsArguments* args, TR::AbsValue** returnValue, int32_t callerIndex)
   {
   ...
   *returnValue = interpreter.getReturnValue();
